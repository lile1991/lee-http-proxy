...
import io.le.proxy.server.handler.http.relay.http.HttpConnectToHttpProxyInitHandler;
 ...
 */
@Slf4j
public class HttpConnectToHttpsProxyHandler extends ChannelInboundHandlerAdapter {

    HttpRequestInfo httpRequestInfo;
    final ProxyServerConfig serverConfig;

    public HttpConnectToHttpsProxyHandler(ProxyServerConfig serverConfig) {
